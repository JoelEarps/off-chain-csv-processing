...
mod tests {
    ...
    fn no_current_account_entry_deposit() {
        ...
        let result_under_test =
            handle_account_update(&test_deposit_tx_event, &mut client_account_store_under_test);
    ...
    fn simple_deposit_success() {
        ...
        let result_under_test = handle_account_update(
            &test_deposit_tx_event_two,
            &mut client_account_store_under_test,
        );
        assert!(result_under_test.is_ok());
